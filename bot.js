...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("https://www.enjore.com/en/teamtable/101459/division-2/");
    this.res.end();
  }
  else if (request.text && botGoldenBoot.test(request.text)) {
    this.res.writeHead(200);
    postMessage("https://www.enjore.com/en/score/101457/division-1/");
    this.res.end();
    ...
    this.res.writeHead(200);
    postMessage("https://docs.google.com/document/d/1mo2T-k0bvbnl5UPQUCI1Ef3mnO99ttZN6tWMG-KpNzQ/pub");
    this.res.end();
  } 
